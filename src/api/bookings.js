...
export const createBooking = async (
  ...
  try {
    const response = await fetch(
      `https://bartist-examen-backend.vercel.app/bookings/createBooking`,
      {
        method: "POST",
        headers: {
...
export const displayBookings = async (token, isVenue) => {
  try {
    const response = await fetch(
      `https://bartist-examen-backend.vercel.app/bookings/displayAllBookings`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const updateBookingStatus = async (id, status) => {
  try {
    const response = await fetch(
      `https://bartist-examen-backend.vercel.app/bookings/updateBookingStatus`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const getBookingByEventId = async (id) => {
  try{
    const response = await fetch(
      `https://bartist-examen-backend.vercel.app/bookings/id/${id}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
